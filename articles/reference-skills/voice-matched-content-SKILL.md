...
description: "Extract someone's authentic writing voice from samples, build a complete Voice DNA profile, then generate content that sounds like them -- not AI. Covers confidence calibration, energy mapping, transition patterns, audience adaptation, and platform-specific voice tuning."
source: https://github.com/openclaw/skills (skills/brianrwagner/voice-matched-content-system)
---
...
- Excitement markers: [how they show it]
...
- **Always produce the Voice DNA Profile first** before generating content.
- **If fewer than 3 samples provided,** flag that the profile will be less accurate.
- **The Voice DNA Profile is the user's asset.** Output it in full so they own it.
